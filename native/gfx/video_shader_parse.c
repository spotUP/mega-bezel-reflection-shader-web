...
#endif /* !MBZ_STANDALONE - end of wildcard types + file_change_data */
...
#endif /* !MBZ_STANDALONE */

#ifdef MBZ_STANDALONE
static void video_shader_replace_wildcards(char *s, size_t len, char *in_preset_path)
{
   (void)s; (void)len; (void)in_preset_path;
}
#endif
...
#endif /* !MBZ_STANDALONE - end of write_root_preset */
...
#endif /* !MBZ_STANDALONE - end of write helper functions */
...
#endif /* !MBZ_STANDALONE - end of write functions */
  ...
  /* If the root_conf path matches the original path then
   ...
   if (string_is_equal(root_conf->path, path))
   {
      ...
      video_shader_load_root_config_into_shader(root_conf,
            ...
            false,
#else
            config_get_ptr()->bools.video_shader_watch_files,
#endif
            shader);
      goto end;
   }
