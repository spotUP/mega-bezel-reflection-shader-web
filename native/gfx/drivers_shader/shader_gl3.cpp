...
static inline uint32_t mbz_get_rotation(void) { return 0; }
#define retroarch_get_rotation() mbz_get_rotation()
#define msg_hash_to_str(x) "N/A"
#define MENU_ENUM_LABEL_VALUE_NOT_AVAILABLE 0
