...
// Included from: globals.inc (/shaders/mega-bezel/shaders/base/common/globals.inc)
#define DEFAULT_CRT_GAMMA 2.4
#define DEFAULT_SRGB_GAMMA 2.2
#define DEFAULT_SCREEN_HEIGHT 0.8297
...
#define DEFAULT_UNCORRECTED_BEZEL_SCALE vec2(1.2050, 0.9110)
#define DEFAULT_SCREEN_CORNER_RADIUS 10.0
#define GAMMA_INPUT GAMMA_INPUT
...
#define HSM_INT_SCALE_MODE HSM_INT_SCALE_MODE
#define HSM_INT_SCALE_MULTIPLE_OFFSET HSM_INT_SCALE_MULTIPLE_OFFSET
#define HSM_INT_SCALE_MULTIPLE_OFFSET_LONG HSM_INT_SCALE_MULTIPLE_OFFSET_LONG
#define hiscan hiscan
#define HSM_INTERLACE_MODE HSM_INTERLACE_MODE
#define HSM_INTERLACE_TRIGGER_RES HSM_INTERLACE_TRIGGER_RES
#define HSM_INTERLACE_EFFECT_SMOOTHNESS_INTERS HSM_INTERLACE_EFFECT_SMOOTHNESS_INTERS / 200.0
#define HSM_INTERLACE_SCANLINE_EFFECT HSM_INTERLACE_SCANLINE_EFFECT / 100.0
#define iscans iscans
#define vga_mode vga_mode     // interlace saturation
#define HSM_FAKE_SCANLINE_MODE HSM_FAKE_SCANLINE_MODE
#define HSM_FAKE_SCANLINE_OPACITY HSM_FAKE_SCANLINE_OPACITY / 100.0
#define HSM_FAKE_SCANLINE_RES_MODE HSM_FAKE_SCANLINE_RES_MODE
#define HSM_FAKE_SCANLINE_RES HSM_FAKE_SCANLINE_RES
#define HSM_FAKE_SCANLINE_INT_SCALE HSM_FAKE_SCANLINE_INT_SCALE
#define HSM_FAKE_SCANLINE_ROLL HSM_FAKE_SCANLINE_ROLL / 100.0
#define HSM_FAKE_SCANLINE_CURVATURE HSM_FAKE_SCANLINE_CURVATURE / 100.0
...
#define HSM_OVERSCAN_RASTER_BLOOM_ON HSM_OVERSCAN_RASTER_BLOOM_ON
#define HSM_OVERSCAN_RASTER_BLOOM_MODE HSM_OVERSCAN_RASTER_BLOOM_MODE
#define HSM_OVERSCAN_RASTER_BLOOM_AMOUNT HSM_OVERSCAN_RASTER_BLOOM_AMOUNT / 100.0     // Bloom overscan percentage
#define HSM_OVERSCAN_RASTER_BLOOM_NEUTRAL_RANGE HSM_OVERSCAN_RASTER_BLOOM_NEUTRAL_RANGE
#define HSM_OVERSCAN_RASTER_BLOOM_NEUTRAL_RANGE_CENTER HSM_OVERSCAN_RASTER_BLOOM_NEUTRAL_RANGE_CENTER
#define HSM_CURVATURE_2D_SCALE_LONG_AXIS HSM_CURVATURE_2D_SCALE_LONG_AXIS / 100.0
#define HSM_CURVATURE_2D_SCALE_SHORT_AXIS HSM_CURVATURE_2D_SCALE_SHORT_AXIS / 100.0
#define HSM_SIGNAL_NOISE_ON HSM_SIGNAL_NOISE_ON
#define HSM_SIGNAL_NOISE_AMOUNT HSM_SIGNAL_NOISE_AMOUNT
#define HSM_SIGNAL_NOISE_BLACK_LEVEL HSM_SIGNAL_NOISE_BLACK_LEVEL / 100.0
#define HSM_SIGNAL_NOISE_SIZE_MODE HSM_SIGNAL_NOISE_SIZE_MODE
#define HSM_SIGNAL_NOISE_SIZE_MULT HSM_SIGNAL_NOISE_SIZE_MULT
#define HSM_SIGNAL_NOISE_TYPE HSM_SIGNAL_NOISE_TYPE
#define HSM_ANTI_FLICKER_ON HSM_ANTI_FLICKER_ON
#define HSM_ANTI_FLICKER_THRESHOLD HSM_ANTI_FLICKER_THRESHOLD / 100.0
#define HSM_SCREEN_VIGNETTE_ON HSM_SCREEN_VIGNETTE_ON
#define HSM_SCREEN_VIGNETTE_STRENGTH (1.0 - HSM_SCREEN_VIGNETTE_STRENGTH / 100.0) * 50.0
#define HSM_SCREEN_VIGNETTE_POWER HSM_SCREEN_VIGNETTE_POWER / 100.0
#define HSM_SCREEN_VIGNETTE_IN_REFLECTION HSM_SCREEN_VIGNETTE_IN_REFLECTION / 100.0
#define HSM_MONOCHROME_MODE HSM_MONOCHROME_MODE
#define HSM_MONOCHROME_BRIGHTNESS HSM_MONOCHROME_BRIGHTNESS / 100.0
#define HSM_MONOCHROME_GAMMA HSM_MONOCHROME_GAMMA
...
#define HSM_TUBE_DIFFUSE_FORCE_ASPECT HSM_TUBE_DIFFUSE_FORCE_ASPECT
#define HSM_TUBE_EXPLICIT_ASPECT HSM_TUBE_EXPLICIT_ASPECT
...
#define HSM_CRT_BLEND_MODE HSM_CRT_BLEND_MODE
#define HSM_CRT_BLEND_AMOUNT HSM_CRT_BLEND_AMOUNT / 100.0
#define HSM_GLOBAL_CORNER_RADIUS HSM_GLOBAL_CORNER_RADIUS
#define HSM_TUBE_BLACK_EDGE_CORNER_RADIUS_SCALE HSM_TUBE_BLACK_EDGE_CORNER_RADIUS_SCALE / 100.0
#define HSM_TUBE_BLACK_EDGE_SHARPNESS HSM_TUBE_BLACK_EDGE_SHARPNESS / 100.0
#define HSM_TUBE_BLACK_EDGE_CURVATURE_SCALE HSM_TUBE_BLACK_EDGE_CURVATURE_SCALE / 100.0
...
#define HSM_BZL_USE_INDEPENDENT_SCALE HSM_BZL_USE_INDEPENDENT_SCALE
#define HSM_BZL_INDEPENDENT_SCALE HSM_BZL_INDEPENDENT_SCALE / 100.0
#define HSM_BZL_USE_INDEPENDENT_CURVATURE HSM_BZL_USE_INDEPENDENT_CURVATURE
#define HSM_BZL_INDEPENDENT_CURVATURE_SCALE_LONG_AXIS HSM_BZL_INDEPENDENT_CURVATURE_SCALE_LONG_AXIS / 100.0
#define HSM_BZL_INDEPENDENT_CURVATURE_SCALE_SHORT_AXIS HSM_BZL_INDEPENDENT_CURVATURE_SCALE_SHORT_AXIS / 100.0
#define HSM_BZL_SCALE_OFFSET HSM_BZL_SCALE_OFFSET / 100.0
#define HSM_BZL_INNER_CURVATURE_SCALE HSM_BZL_INNER_CURVATURE_SCALE / 100.0
...
float HSM_GetNoScanlineMode()
{
	...
	return no_scanlines > 0.5 || (HSM_GetUseFakeScanlines() > 0.5) || HSM_INTERLACE_MODE < 0.0 && HSM_INTERLACE_TRIGGER_RES <= scan_res ? 1.0 : 0.0;
}
